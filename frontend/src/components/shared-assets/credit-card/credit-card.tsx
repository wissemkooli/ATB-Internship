  ...
  return (
    ...
    >
      <div
        ...
        className={cx(
          "absolute top-0 left-0 flex origin-top-left flex-col justify-between overflow-hidden rounded-[24px] p-[22px]",
          styles[type].root,
        )}
      >
        ...
        <div className="relative flex items-start justify-between px-1 pt-1">
          <div className={cx("whitespace-nowrap text-[18px] leading-none font-semibold tracking-[-0.02em]", styles[type].company)}>
            {company}
          </div>
        ...
        <div className="relative flex items-end justify-between gap-3">
          <div className="flex min-w-0 flex-col gap-2">
            <div className="flex items-center gap-2">
              <p
                ...
                className={cx("whitespace-nowrap text-[11px] leading-none font-semibold tracking-[0.06em] uppercase", styles[type].footerText)}
              >
                {cardHolder}
              </p>
              <p
                className={cx("ml-auto whitespace-nowrap text-right text-[11px] leading-none font-semibold tracking-[0.06em] tabular-nums", styles[type].footerText)}
              >
                {cardExpiration}
              </p>
            </div>
            <div
              className={cx(
                "whitespace-nowrap text-[20px] leading-none font-semibold tracking-[0.08em] tabular-nums",
          ...
          <div className={cx("flex h-[40px] w-[58px] shrink-0 items-center justify-center rounded-[8px]", styles[type].cardTypeRoot)}>
